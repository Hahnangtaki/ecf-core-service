...
/**
 * A DTO for the {@link id.tech.cakra.ecfcoresvc.domain.AccountAddress} entity.
 */
public class AccountAddressDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (accountAddressDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), accountAddressDTO.getId());
    }

...
public class CampaignTransaction implements Serializable {
    ...
    @Column(name = "unique_charges", precision = 21, scale = 2)
    private BigDecimal uniqueCharges;
    ...
    public CampaignTransaction qty(BigDecimal qty) {
        this.qty = qty;
        return this;
    }
    ...
    public CampaignTransaction amount(BigDecimal amount) {
        this.amount = amount;
        return this;
    }
    ...
    public BigDecimal getUniqueCharges() {
        return uniqueCharges;
    }

    public CampaignTransaction uniqueCharges(BigDecimal uniqueCharges) {
        this.uniqueCharges = uniqueCharges;
        return this;
    }

    public void setUniqueCharges(BigDecimal uniqueCharges) {
        this.uniqueCharges = uniqueCharges;
    }
    ...
    public CampaignTransaction netAmount(BigDecimal netAmount) {

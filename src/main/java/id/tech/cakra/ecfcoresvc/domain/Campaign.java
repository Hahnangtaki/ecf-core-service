...
public class Campaign implements Serializable {
    ...
    public Campaign price(BigDecimal price) {
        this.price = price;
        return this;
    }
    ...
    public Campaign fundTarget(BigDecimal fundTarget) {
    ...
    public Campaign fundRaised(BigDecimal fundRaised) {
    ...
    public Campaign fundPaid(BigDecimal fundPaid) {
    ...
    public Campaign qtyTarget(BigDecimal qtyTarget) {
    ...
    public Campaign qtyRaised(BigDecimal qtyRaised) {
    ...
    public Campaign estRoiMin(BigDecimal estRoiMin) {
    ...
    public Campaign estRoiMax(BigDecimal estRoiMax) {

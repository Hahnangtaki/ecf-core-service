...
/**
 * REST controller for managing {@link id.tech.cakra.ecfcoresvc.domain.CampaignTransaction}.
 */
@RestController
@RequestMapping("/api")
public class CampaignTransactionResource {
    ...
    private static final String ENTITY_NAME = "ecfcoresvcCampaignTransaction";

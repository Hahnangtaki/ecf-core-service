...
public class CampaignInvestorResourceIT {
    ...
    private static final Long DEFAULT_QTY_ON_HAND = 1L;
    private static final Long UPDATED_QTY_ON_HAND = 2L;

    private static final Long DEFAULT_QTY_DEPOSIT = 1L;
    private static final Long UPDATED_QTY_DEPOSIT = 2L;

    private static final Long DEFAULT_QTY_WITHDRAW = 1L;
    private static final Long UPDATED_QTY_WITHDRAW = 2L;

    private static final Double DEFAULT_CAST_VALUE = 1D;
    private static final Double UPDATED_CAST_VALUE = 2D;

    private static final Double DEFAULT_PROFIT_LOSS = 1D;
    private static final Double UPDATED_PROFIT_LOSS = 2D;
    ...
    public void getAllCampaignInvestors() throws Exception {
        ...
        restCampaignInvestorMockMvc.perform(get("/api/campaign-investors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].castValue").value(hasItem(DEFAULT_CAST_VALUE.doubleValue())))
            .andExpect(jsonPath("$.[*].profitLoss").value(hasItem(DEFAULT_PROFIT_LOSS.doubleValue())))
    ...
    public void getCampaignInvestor() throws Exception {
        ...
        restCampaignInvestorMockMvc.perform(get("/api/campaign-investors/{id}", campaignInvestor.getId()))
            ...
            .andExpect(jsonPath("$.castValue").value(DEFAULT_CAST_VALUE.doubleValue()))
            .andExpect(jsonPath("$.profitLoss").value(DEFAULT_PROFIT_LOSS.doubleValue()))

...
import id.tech.cakra.ecfcoresvc.repository.CompanyBankRepository;
import id.tech.cakra.ecfcoresvc.service.CompanyBankService;
import id.tech.cakra.ecfcoresvc.service.dto.CompanyBankDTO;
import id.tech.cakra.ecfcoresvc.service.mapper.CompanyBankMapper;
...
public class CompanyBankResourceIT {
    ...
    public void createCompanyBank() throws Exception {
        ...
        assertThat(testCompanyBank.getBankId()).isEqualTo(DEFAULT_BANK_ID);
        assertThat(testCompanyBank.getCurrencyId()).isEqualTo(DEFAULT_CURRENCY_ID);
    ...
    public void updateCompanyBank() throws Exception {
        ...
        assertThat(testCompanyBank.getBankId()).isEqualTo(UPDATED_BANK_ID);
        assertThat(testCompanyBank.getCurrencyId()).isEqualTo(UPDATED_CURRENCY_ID);
